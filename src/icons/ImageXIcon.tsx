...
export interface ImageXIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const ImageXIcon = React.forwardRef<SVGSVGElement, ImageXIconProps>(
...
ImageXIcon.displayName = 'ImageXIcon';

export { ImageXIcon };
export default ImageXIcon;
