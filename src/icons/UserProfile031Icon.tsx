...
export interface UserProfile031IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const UserProfile031Icon = React.forwardRef<SVGSVGElement, UserProfile031IconProps>(
...
UserProfile031Icon.displayName = 'UserProfile031Icon';

export { UserProfile031Icon };
export default UserProfile031Icon;
