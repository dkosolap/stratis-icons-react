...
export interface CalendarMinusIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const CalendarMinusIcon = React.forwardRef<SVGSVGElement, CalendarMinusIconProps>(
