...
export interface Card02IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Card02Icon = React.forwardRef<SVGSVGElement, Card02IconProps>(
...
Card02Icon.displayName = 'Card02Icon';

export { Card02Icon };
export default Card02Icon;
