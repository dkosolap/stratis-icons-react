...
export interface CoinUnbrokenIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const CoinUnbrokenIcon = React.forwardRef<SVGSVGElement, CoinUnbrokenIconProps>(
...
CoinUnbrokenIcon.displayName = 'CoinUnbrokenIcon';

export { CoinUnbrokenIcon };
export default CoinUnbrokenIcon;
