...
export interface CurrencyDollarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const CurrencyDollarIcon = React.forwardRef<SVGSVGElement, CurrencyDollarIconProps>(
