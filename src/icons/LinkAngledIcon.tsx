...
export interface LinkAngledIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const LinkAngledIcon = React.forwardRef<SVGSVGElement, LinkAngledIconProps>(
