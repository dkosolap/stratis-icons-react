...
export interface CloudRainIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const CloudRainIcon = React.forwardRef<SVGSVGElement, CloudRainIconProps>(
