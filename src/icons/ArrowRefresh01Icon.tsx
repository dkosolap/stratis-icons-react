...
export interface ArrowRefresh01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const ArrowRefresh01Icon = React.forwardRef<SVGSVGElement, ArrowRefresh01IconProps>(
...
ArrowRefresh01Icon.displayName = 'ArrowRefresh01Icon';

export { ArrowRefresh01Icon };
export default ArrowRefresh01Icon;
