...
export interface Compass1IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Compass1Icon = React.forwardRef<SVGSVGElement, Compass1IconProps>(
