...
export interface CursorArrowIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const CursorArrowIcon = React.forwardRef<SVGSVGElement, CursorArrowIconProps>(
...
CursorArrowIcon.displayName = 'CursorArrowIcon';
