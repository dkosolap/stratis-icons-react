...
export interface AnnotationXIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const AnnotationXIcon = React.forwardRef<SVGSVGElement, AnnotationXIconProps>(
...
AnnotationXIcon.displayName = 'AnnotationXIcon';

export { AnnotationXIcon };
export default AnnotationXIcon;
