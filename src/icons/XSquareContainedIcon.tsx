...
export interface XSquareContainedIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const XSquareContainedIcon = React.forwardRef<SVGSVGElement, XSquareContainedIconProps>(
...
XSquareContainedIcon.displayName = 'XSquareContainedIcon';

export { XSquareContainedIcon };
export default XSquareContainedIcon;
