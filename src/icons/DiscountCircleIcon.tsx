...
export interface DiscountCircleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const DiscountCircleIcon = React.forwardRef<SVGSVGElement, DiscountCircleIconProps>(
...
export { DiscountCircleIcon };
export default DiscountCircleIcon;
