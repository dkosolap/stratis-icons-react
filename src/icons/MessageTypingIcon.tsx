...
export interface MessageTypingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const MessageTypingIcon = React.forwardRef<SVGSVGElement, MessageTypingIconProps>(
...
MessageTypingIcon.displayName = 'MessageTypingIcon';

export { MessageTypingIcon };
export default MessageTypingIcon;
