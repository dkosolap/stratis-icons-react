...
export interface Microphone01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Microphone01Icon = React.forwardRef<SVGSVGElement, Microphone01IconProps>(
