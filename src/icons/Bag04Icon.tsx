...
export interface Bag04IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Bag04Icon = React.forwardRef<SVGSVGElement, Bag04IconProps>(
...
Bag04Icon.displayName = 'Bag04Icon';

export { Bag04Icon };
export default Bag04Icon;
