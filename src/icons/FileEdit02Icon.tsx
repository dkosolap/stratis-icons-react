...
export interface FileEdit02IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const FileEdit02Icon = React.forwardRef<SVGSVGElement, FileEdit02IconProps>(
...
FileEdit02Icon.displayName = 'FileEdit02Icon';

export { FileEdit02Icon };
export default FileEdit02Icon;
