...
export interface Calendar04IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Calendar04Icon = React.forwardRef<SVGSVGElement, Calendar04IconProps>(
