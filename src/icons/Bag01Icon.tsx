...
export interface Bag01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Bag01Icon = React.forwardRef<SVGSVGElement, Bag01IconProps>(
...
Bag01Icon.displayName = 'Bag01Icon';
