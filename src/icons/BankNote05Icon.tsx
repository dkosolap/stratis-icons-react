...
export interface BankNote05IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const BankNote05Icon = React.forwardRef<SVGSVGElement, BankNote05IconProps>(
...
BankNote05Icon.displayName = 'BankNote05Icon';

export { BankNote05Icon };
export default BankNote05Icon;
