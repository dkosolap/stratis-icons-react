...
export interface BatteryFill01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const BatteryFill01Icon = React.forwardRef<SVGSVGElement, BatteryFill01IconProps>(
...
BatteryFill01Icon.displayName = 'BatteryFill01Icon';

export { BatteryFill01Icon };
export default BatteryFill01Icon;
