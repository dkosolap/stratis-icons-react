...
export interface ChromecastIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const ChromecastIcon = React.forwardRef<SVGSVGElement, ChromecastIconProps>(
