...
export interface FilePlus02IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const FilePlus02Icon = React.forwardRef<SVGSVGElement, FilePlus02IconProps>(
...
FilePlus02Icon.displayName = 'FilePlus02Icon';

export { FilePlus02Icon };
export default FilePlus02Icon;
