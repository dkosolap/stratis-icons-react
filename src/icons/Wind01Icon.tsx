...
export interface Wind01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Wind01Icon = React.forwardRef<SVGSVGElement, Wind01IconProps>(
