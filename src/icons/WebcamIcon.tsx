...
export interface WebcamIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const WebcamIcon = React.forwardRef<SVGSVGElement, WebcamIconProps>(
