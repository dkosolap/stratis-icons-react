...
export interface Microphone02IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Microphone02Icon = React.forwardRef<SVGSVGElement, Microphone02IconProps>(
...
export default Microphone02Icon;
