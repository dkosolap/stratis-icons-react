...
export interface ImageAvatarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const ImageAvatarIcon = React.forwardRef<SVGSVGElement, ImageAvatarIconProps>(
...
ImageAvatarIcon.displayName = 'ImageAvatarIcon';

export { ImageAvatarIcon };
export default ImageAvatarIcon;
