...
export interface EditContainedIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const EditContainedIcon = React.forwardRef<SVGSVGElement, EditContainedIconProps>(
