...
export interface CurrencyCoinRubelIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const CurrencyCoinRubelIcon = React.forwardRef<SVGSVGElement, CurrencyCoinRubelIconProps>(
