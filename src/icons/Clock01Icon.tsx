...
export interface Clock01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Clock01Icon = React.forwardRef<SVGSVGElement, Clock01IconProps>(
