...
export interface DotHorizontalIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const DotHorizontalIcon = React.forwardRef<SVGSVGElement, DotHorizontalIconProps>(
...
DotHorizontalIcon.displayName = 'DotHorizontalIcon';

export { DotHorizontalIcon };
