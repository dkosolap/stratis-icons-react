...
export interface Cursor04IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Cursor04Icon = React.forwardRef<SVGSVGElement, Cursor04IconProps>(
...
Cursor04Icon.displayName = 'Cursor04Icon';
