...
export interface MicrophoneOff01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const MicrophoneOff01Icon = React.forwardRef<SVGSVGElement, MicrophoneOff01IconProps>(
