...
export interface DotVerticalIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const DotVerticalIcon = React.forwardRef<SVGSVGElement, DotVerticalIconProps>(
...
DotVerticalIcon.displayName = 'DotVerticalIcon';
