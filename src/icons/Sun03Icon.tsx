...
export interface Sun03IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Sun03Icon = React.forwardRef<SVGSVGElement, Sun03IconProps>(
