...
export interface PhoneUpIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const PhoneUpIcon = React.forwardRef<SVGSVGElement, PhoneUpIconProps>(
