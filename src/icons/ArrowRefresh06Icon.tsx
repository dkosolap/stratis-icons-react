...
export interface ArrowRefresh06IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const ArrowRefresh06Icon = React.forwardRef<SVGSVGElement, ArrowRefresh06IconProps>(
...
ArrowRefresh06Icon.displayName = 'ArrowRefresh06Icon';

export { ArrowRefresh06Icon };
export default ArrowRefresh06Icon;
