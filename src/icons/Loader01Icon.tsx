...
export interface Loader01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Loader01Icon = React.forwardRef<SVGSVGElement, Loader01IconProps>(
...
Loader01Icon.displayName = 'Loader01Icon';

export { Loader01Icon };
export default Loader01Icon;
