...
export interface BarChartSquare02IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const BarChartSquare02Icon = React.forwardRef<SVGSVGElement, BarChartSquare02IconProps>(
...
BarChartSquare02Icon.displayName = 'BarChartSquare02Icon';
