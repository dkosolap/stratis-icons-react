...
export interface Code04IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Code04Icon = React.forwardRef<SVGSVGElement, Code04IconProps>(
...
Code04Icon.displayName = 'Code04Icon';

export { Code04Icon };
export default Code04Icon;
