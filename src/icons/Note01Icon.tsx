...
export interface Note01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Note01Icon = React.forwardRef<SVGSVGElement, Note01IconProps>(
...
Note01Icon.displayName = 'Note01Icon';
