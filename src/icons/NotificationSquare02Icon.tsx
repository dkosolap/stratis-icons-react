...
export interface NotificationSquare02IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const NotificationSquare02Icon = React.forwardRef<SVGSVGElement, NotificationSquare02IconProps>(
...
NotificationSquare02Icon.displayName = 'NotificationSquare02Icon';

export { NotificationSquare02Icon };
export default NotificationSquare02Icon;
