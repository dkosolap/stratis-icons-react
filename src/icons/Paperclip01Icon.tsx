...
export interface Paperclip01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Paperclip01Icon = React.forwardRef<SVGSVGElement, Paperclip01IconProps>(
...
Paperclip01Icon.displayName = 'Paperclip01Icon';

export { Paperclip01Icon };
export default Paperclip01Icon;
