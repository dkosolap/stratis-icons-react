...
export interface Trash02IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Trash02Icon = React.forwardRef<SVGSVGElement, Trash02IconProps>(
