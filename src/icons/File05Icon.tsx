...
export interface File05IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const File05Icon = React.forwardRef<SVGSVGElement, File05IconProps>(
...
File05Icon.displayName = 'File05Icon';
