...
export interface BarGroup01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const BarGroup01Icon = React.forwardRef<SVGSVGElement, BarGroup01IconProps>(
...
BarGroup01Icon.displayName = 'BarGroup01Icon';

export { BarGroup01Icon };
export default BarGroup01Icon;
