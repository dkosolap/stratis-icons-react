...
export interface Stopwatch05IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Stopwatch05Icon = React.forwardRef<SVGSVGElement, Stopwatch05IconProps>(
...
Stopwatch05Icon.displayName = 'Stopwatch05Icon';

export { Stopwatch05Icon };
export default Stopwatch05Icon;
