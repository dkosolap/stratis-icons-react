...
export interface CheckContainedIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const CheckContainedIcon = React.forwardRef<SVGSVGElement, CheckContainedIconProps>(
...
CheckContainedIcon.displayName = 'CheckContainedIcon';

export { CheckContainedIcon };
