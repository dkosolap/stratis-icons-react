...
export interface Server03IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Server03Icon = React.forwardRef<SVGSVGElement, Server03IconProps>(
