...
export interface Globe04IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Globe04Icon = React.forwardRef<SVGSVGElement, Globe04IconProps>(
