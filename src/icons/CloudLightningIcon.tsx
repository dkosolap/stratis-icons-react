...
export interface CloudLightningIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const CloudLightningIcon = React.forwardRef<SVGSVGElement, CloudLightningIconProps>(
