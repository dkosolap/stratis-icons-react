...
export interface Bag02IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Bag02Icon = React.forwardRef<SVGSVGElement, Bag02IconProps>(
...
Bag02Icon.displayName = 'Bag02Icon';
