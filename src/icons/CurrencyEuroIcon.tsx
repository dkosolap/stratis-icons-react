...
export interface CurrencyEuroIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const CurrencyEuroIcon = React.forwardRef<SVGSVGElement, CurrencyEuroIconProps>(
