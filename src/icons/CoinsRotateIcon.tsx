...
export interface CoinsRotateIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const CoinsRotateIcon = React.forwardRef<SVGSVGElement, CoinsRotateIconProps>(
...
CoinsRotateIcon.displayName = 'CoinsRotateIcon';

export { CoinsRotateIcon };
export default CoinsRotateIcon;
