...
export interface GitBranch01IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const GitBranch01Icon = React.forwardRef<SVGSVGElement, GitBranch01IconProps>(
