...
export interface Map02IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Map02Icon = React.forwardRef<SVGSVGElement, Map02IconProps>(
