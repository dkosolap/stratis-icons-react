...
export interface AnnotationCheckIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const AnnotationCheckIcon = React.forwardRef<SVGSVGElement, AnnotationCheckIconProps>(
...
AnnotationCheckIcon.displayName = 'AnnotationCheckIcon';

export { AnnotationCheckIcon };
export default AnnotationCheckIcon;
