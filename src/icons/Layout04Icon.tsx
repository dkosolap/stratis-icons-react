...
export interface Layout04IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
}

const Layout04Icon = React.forwardRef<SVGSVGElement, Layout04IconProps>(
...
Layout04Icon.displayName = 'Layout04Icon';

export { Layout04Icon };
export default Layout04Icon;
